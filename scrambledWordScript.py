...
def main():
    if len(sys.argv) != 2:
        print("Usage: python scrambledWordScript.py <difficulty>")
        print("Difficulty levels: Beginner, Intermediate, Advanced, Expert")
        sys.exit(1)

    difficulty = sys.argv[1]
    if difficulty not in words:
        print("Invalid difficulty level. Choose from: Beginner, Intermediate, Advanced, Expert")
        sys.exit(1)
