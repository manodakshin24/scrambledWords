...
words = {
    ...
    "Advanced": ["astronomy", "healthcare", "chemistry", "dinosaur", "naturalized", "geography", "history", "jupiter", "kaleidoscope", "lightning", "mathematics", "neptune", "oxygen", "planet", "quasar"],
